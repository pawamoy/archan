...
When `reporting a bug <https://github.com/Genida/archan/issues>`_ please include:
...
1. Fork `archan <https://github.com/Genida/archan>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on...
       ...
       - **Travis**: it will `run the tests <https://travis-ci.org/Genida/archan/pull_requests>`_ for each change you add in the pull request.
